# File Checksum Verifier | Compare SHA-256 & MD5 Digests

> Compare and verify cryptographic file checksums and hash digests offline. Fast string comparison with zero network uploads.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/file-checksum/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/file-checksum/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/file-checksum/](https://cig13zs.github.io/file-checksum/) or install the offline Chrome Extension package.
...
Paste the expected checksum and actual checksum on separate lines to verify bit-for-bit file integrity.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/file-checksum.git
   ```
